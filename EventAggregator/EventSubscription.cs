    ...
    public class EventSubscription : IEventSubscription
    {
        ...
        public EventSubscription(IDelegateReference actionReference)
        {
            ...
            if (!(actionReference.Target is Action))
                throw new ArgumentException(string.Format(CultureInfo.CurrentCulture, "Invalid delegate reference type", typeof(Action).FullName), nameof(actionReference));
    ...
    public class EventSubscription<TPayload> : IEventSubscription
    {
        ...
        public EventSubscription(IDelegateReference actionReference, IDelegateReference filterReference)
        {
            ...
            if (!(actionReference.Target is Action<TPayload>))
                throw new ArgumentException(string.Format(CultureInfo.CurrentCulture, "Invalid delegate reference type", typeof(Action<TPayload>).FullName), nameof(actionReference));

            if (filterReference == null)
                throw new ArgumentNullException(nameof(filterReference));
            if (!(filterReference.Target is Predicate<TPayload>))
                throw new ArgumentException(string.Format(CultureInfo.CurrentCulture, "Invalid delegate reference type", typeof(Predicate<TPayload>).FullName), nameof(filterReference));
